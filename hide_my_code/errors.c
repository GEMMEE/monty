...
/**
 * print_subtract_error - Prints the 'can't sub, stack too short' error message
 * @line_number: The line number in the Monty byte code file.
 */
...
/**
 * print_divide_error - Prints the 'can't div, stack too short' error message
 * @line_number: The line number in the Monty byte code file.
 */
...
/**
 * print_modulus_error - Prints an error message if the stack contains less
 *                        two elements.
 * @line_number: The line number in the Monty byte code file.
 */
